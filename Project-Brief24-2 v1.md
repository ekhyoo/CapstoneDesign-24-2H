...
| (7) 과제 내용 요약 | 주입식 위주의 지루한 미술 관람과 드로잉 위주의 교육으로 미술 교과목이 어려운 초등학생을 대상으로, AI 도슨트와 대화하며 작품을 감상하고, 이미지 생성 AI로 나만의 그림을 창작하며는 애플리케이셥니다. 재미있고, 주체적인 미술 감상 제공을 목표로합니다.  <br>주요기능은 다음과 같습니다.<br> 1. 도슨트 AI와 대화하며 작품 감상 : 미술 감상 이론에 사용되는 2가지 모델을 적용한 프롬프트를 통해, AI 도슨트의 단계별 질문에 답하며 주체적이고, 체계적인 작품 감상이 가능합니다. 또한, 도슨트 캐릭터와 TTS & SST 기술을 활용해 자유롭고 친밀하게 상호작용할 수 있는 대화형 감상을 제공합니다. <br> 2. RAG를 이용한 깊이있는 작품 감상 : 작품 감상 과정에 도움이 되는 정보를 활용하여 사용자에게 보다 정확하고 풍부한 정보를 제공합니다. <br>3. 이미지 생성 AI를 이용한 그림 창작 : 감상한 작품에 관람자의 창의적인 아이디어를 반영하여, 이미지 생성 AI 통해 새로운 그림을 창작합니다. 이때 관람자의 특징 또는 작가의 화풍을 반영하여 다양한 그림 창작을 지원합니다. 
| (10) 기타 |  |

...
| 항목 | 내용 |
|:---  |---  |
| (1) 요구사항 정의 | <br> 예) <br> - 기능별 상세 요구사항(또는 유스케이스) <br> - 설계 모델(클래스 다이어그램, 클래스 및 모듈 명세서) ![image](https://github.com/user-attachments/assets/7338f176-3bd1-4da9-894c-9e83aca40376)

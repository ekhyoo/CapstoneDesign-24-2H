...
| (3) 진척도 및 검증내역 | **스타트 단계에서의 기술 구현**<br>- Back-End : 매칭 알고리즘 부분 구현 및 회원가입 구현<br>- Front-End : 진행X <br> - AI part : 데이터셋 학습 및 데이터 크롤링<br>**그로쓰 진행 상황**<br>- Back-End : 로그인/로그아웃 및 AWS 연결 완료 <br>**30프로 구현 완료**<br>- Front-End : 메인페이지, 로그인/로그아웃, 회원가입, 마이페이지, 요청서 구현 완료 <br>**50프로 구현 완료**<br> - AI part : 사용할 오픈 소스 기반 수정 중 <br> **20프로 구현 완료**<br> |
| (4) 기타 | *기타 사항을 기술* |
